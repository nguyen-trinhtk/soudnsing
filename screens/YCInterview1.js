...
const YCInterview1 = () => {
  ...
  return (
    <View style={[styles.ycInterview1, styles.frameGroupLayout]}>
      <View style={styles.ycInterview1Child} />
      <Image
        style={[styles.ycInterview1Item, styles.interview1Position]}
        contentFit="cover"
        source={require("../assets/ellipse-2.png")}
      />
      <Image
        style={[styles.ycInterview1Inner, styles.ycInterview1InnerLayout]}
        contentFit="cover"
                  ...
                  >
                    <Image
                      style={[
                        ...
                        styles.ycInterview1InnerLayout,
                      ]}
                      contentFit="cover"
