...
const A22VidBack = () => {
  ...
  return (
    <View style={styles.a22VidBack}>
      <View style={styles.a22VidBackChild} />
...
nhạc dạo`}</Text>
      ...
      <LinearGradient
        style={[styles.a22VidBackItem, styles.a22VidBackItemPosition]}
        locations={[0.21, 0.72]}
      ...
      <View style={[styles.botNavKaraScreen, styles.groupChildPosition]}>
        <View style={styles.botNavKaraScreenInner}>
          <View style={[styles.instanceParent, styles.a22VidBackItemPosition]}>
            <View style={[styles.rectangleWrapper, styles.backgroundLayout]}>
              <Image
                style={[styles.instanceChild, styles.groupIconLayout]}
                contentFit="cover"
            ...
            >
              <Image
                style={[styles.backgroundChild, styles.groupIconLayout]}
                contentFit="cover"
