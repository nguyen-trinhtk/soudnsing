    ...
    <View style={styles.loader2}>
      <View style={[styles.property11, styles.property1loaderLayout]}>
        ...
        <View style={[styles.wrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.text1, styles.xongFlexBox]}>0%</Text>
        </View>
      </View>
      <View style={[styles.property1loader2, styles.property1loaderLayout]}>
        ...
        <View style={[styles.wrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.text1, styles.xongFlexBox]}>10%</Text>
        </View>
      </View>
      <View style={[styles.property1loader3, styles.property1loaderLayout]}>
        ...
        <View style={[styles.wrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.text1, styles.xongFlexBox]}>33%</Text>
        </View>
      </View>
      <View style={[styles.property1loader4, styles.property1loaderLayout]}>
        ...
        <View style={[styles.wrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.text1, styles.xongFlexBox]}>67%</Text>
        </View>
      </View>
      <View style={[styles.property1loader5, styles.property1loaderLayout]}>
        ...
        <View style={[styles.wrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.text1, styles.xongFlexBox]}>89%</Text>
        </View>
      </View>
      <View style={[styles.property1loader6, styles.property1loaderLayout]}>
        ...
        />
        <View style={[styles.wrapper, styles.wrapperFlexBox]}>
          <Text style={[styles.text1, styles.xongFlexBox]}>100%</Text>
        </View>
      </View>
      <Pressable
      ...
      >
        ...
        <View style={[styles.duotoneCheckCircleParent, styles.wrapperFlexBox]}>
          ...
          />
          <Text style={[styles.xong, styles.xongFlexBox]}>Xong</Text>
        </View>
      </Pressable>
    </View>
  );
